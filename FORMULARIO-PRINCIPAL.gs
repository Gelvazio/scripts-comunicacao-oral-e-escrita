...
function criarFormularioAula01() {
  ...
  form.addMultipleChoiceItem().setTitle('12. Qual é a definição correta de "Saber falar e escrever bem não é mágica"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('é um conjunto de técnicas treináveis que transformam oportunidades. Ao longo desta disciplina, você ', true),
  ...
  form.addMultipleChoiceItem().setTitle('16. Qual é a definição correta de "A mensagem é o objeto concreto da transmissão"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('o conjunto de ideias, sentimentos, instruções ou dados enviados. Para ser eficaz, ela precisa ter co', true),
...
function criarFormularioAula02() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 2?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Preparação para Entrevistas Comunicação oral estratégica e postura profissional', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Preparação para Entrevistas Comunicação oral estra..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Preparação para Entrevistas Comunicação " em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Preparação para Entrevistas Comunicação oral estratégica e postura profissional"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Preparação para Entrevistas Comunicação oral estratégica e postura profissional"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula05() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 5?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Formatação e Padronização de Documentos Apresentação visual e clareza na escrita formal', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Formatação e Padronização de Documentos Apresentaç..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Formatação e Padronização de Documentos " em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Formatação e Padronização de Documentos Apresentação visual e clareza na escrita formal"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Formatação e Padronização de Documentos Apresentação visual e clareza na escrita formal"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula06() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 6?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Redação de E-mails Corporativos Comunicação escrita eficaz e profissional no ambiente de trabalho', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Redação de E-mails Corporativos Comunicação escrit..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Redação de E-mails Corporativos Comunica" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Redação de E-mails Corporativos Comunicação escrita eficaz e profissional no ambiente de trabalho"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Redação de E-mails Corporativos Comunicação escrita eficaz e profissional no ambiente de trabalho"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula07() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 7?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Elaboração de Relatórios Técnicos Estrutura, objetividade e análise prática no mundo profissional', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Elaboração de Relatórios Técnicos Estrutura, objet..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Elaboração de Relatórios Técnicos Estrut" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Elaboração de Relatórios Técnicos Estrutura, objetividade e análise prática no mundo profissional"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Elaboração de Relatórios Técnicos Estrutura, objetividade e análise prática no mundo profissional"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula08() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 8?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Redação de Memorandos e Comunicações Internas Agilidade, clareza e alinhamento na rotina corporativa', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Redação de Memorandos e Comunicações Internas Agil..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Redação de Memorandos e Comunicações Internas Agilidade, clareza e alinhamento na rotina corporativa"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Redação de Memorandos e Comunicações Internas Agilidade, clareza e alinhamento na rotina corporativa"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula09() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 9?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Procedimentos e Instruções Como escrever passos claros, sequenciais e sem erros', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Procedimentos e Instruções Como escrever passos cl..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Procedimentos e Instruções Como escrever" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Procedimentos e Instruções Como escrever passos claros, sequenciais e sem erros"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Procedimentos e Instruções Como escrever passos claros, sequenciais e sem erros"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula10() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 10?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Plataformas Digitais de Comunicação Conectando equipes com eficiência, agilidade e clareza no trabalho.', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Plataformas Digitais de Comunicação Conectando equ..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Plataformas Digitais de Comunicação Cone" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Plataformas Digitais de Comunicação Conectando equipes com eficiência, agilidade e clareza no trabalho."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Plataformas Digitais de Comunicação Conectando equipes com eficiência, agilidade e clareza no trabalho."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula11() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 11?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Segurança da Informação e Privacidade Protegendo dados, canais e reputação no ambiente digital corporativo', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Segurança da Informação e Privacidade Protegendo d..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Segurança da Informação e Privacidade Pr" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Segurança da Informação e Privacidade Protegendo dados, canais e reputação no ambiente digital corporativo"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Segurança da Informação e Privacidade Protegendo dados, canais e reputação no ambiente digital corporativo"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula12() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 12?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Comunicação Eficaz Como transformar ideias em mensagens claras, precisas e compreensíveis', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Comunicação Eficaz Como transformar ideias em mens..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Comunicação Eficaz Como transformar idei" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Comunicação Eficaz Como transformar ideias em mensagens claras, precisas e compreensíveis"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Comunicação Eficaz Como transformar ideias em mensagens claras, precisas e compreensíveis"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula13() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 13?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Etiqueta Digital e Netiqueta Convivência e postura ética no ambiente virtual', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Etiqueta Digital e Netiqueta Convivência e postura..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Etiqueta Digital e Netiqueta Convivência" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Etiqueta Digital e Netiqueta Convivência e postura ética no ambiente virtual"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Etiqueta Digital e Netiqueta Convivência e postura ética no ambiente virtual"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula14() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 14?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Trabalho Remoto e Colaboração Práticas e ferramentas para produzir em equipe digital', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Trabalho Remoto e Colaboração Práticas e ferrament..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Trabalho Remoto e Colaboração Práticas e" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Trabalho Remoto e Colaboração Práticas e ferramentas para produzir em equipe digital"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Trabalho Remoto e Colaboração Práticas e ferramentas para produzir em equipe digital"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula15() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 15?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Linguagem Corporal e Comunicação O poder dos sinais não-verbais no ambiente profissional', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Linguagem Corporal e Comunicação O poder dos sinai..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Linguagem Corporal e Comunicação O poder" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Linguagem Corporal e Comunicação O poder dos sinais não-verbais no ambiente profissional"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Linguagem Corporal e Comunicação O poder dos sinais não-verbais no ambiente profissional"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula16() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 16?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Gestual, Tom de Voz e Sincronismo A harmonia perfeita entre corpo, voz e mensagem profissional', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Gestual, Tom de Voz e Sincronismo A harmonia perfe..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Gestual, Tom de Voz e Sincronismo A harm" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Gestual, Tom de Voz e Sincronismo A harmonia perfeita entre corpo, voz e mensagem profissional"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Gestual, Tom de Voz e Sincronismo A harmonia perfeita entre corpo, voz e mensagem profissional"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula17() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 17?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Integração Prática: O Projeto Capstone Unindo escrita técnica, oratória e ferramentas digitais', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Integração Prática: O Projeto Capstone Unindo escr..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Integração Prática: O Projeto Capstone U" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('12. Qual é a definição correta de "Integração Prática"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('O Projeto Capstone Unindo escrita técnica, oratória e ferramentas digitais', true),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Integração Prática: O Projeto Capstone Unindo escrita técnica, oratória e ferramentas digitais"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Integração Prática: O Projeto Capstone Unindo escrita técnica, oratória e ferramentas digitais"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula19() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 19?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('O Ciclo do Feedback na Comunicação Como transformar respostas em ferramentas de crescimento e alinhamento', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "O Ciclo do Feedback na Comunicação Como transforma..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "O Ciclo do Feedback na Comunicação Como " em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "O Ciclo do Feedback na Comunicação Como transformar respostas em ferramentas de crescimento e alinhamento"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "O Ciclo do Feedback na Comunicação Como transformar respostas em ferramentas de crescimento e alinhamento"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula20() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 20?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Contextos Formais versus Informais Adequação comunicativa, registros e impacto profissional', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Contextos Formais versus Informais Adequação comun..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Contextos Formais versus Informais Adequ" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Contextos Formais versus Informais Adequação comunicativa, registros e impacto profissional"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Contextos Formais versus Informais Adequação comunicativa, registros e impacto profissional"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula21() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 21?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Síntese dos Fundamentos da Comunicação Consolidação e Prática do Módulo 1', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Síntese dos Fundamentos da Comunicação Consolidaçã..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Síntese dos Fundamentos da Comunicação C" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Síntese dos Fundamentos da Comunicação Consolidação e Prática do Módulo 1"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Síntese dos Fundamentos da Comunicação Consolidação e Prática do Módulo 1"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula22() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 22?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Estrutura de Apresentações Como planejar discursos memoráveis, claros e persuasivos', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Estrutura de Apresentações Como planejar discursos..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Estrutura de Apresentações Como planejar" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Estrutura de Apresentações Como planejar discursos memoráveis, claros e persuasivos"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Estrutura de Apresentações Como planejar discursos memoráveis, claros e persuasivos"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula24() {
  ...
  form.addMultipleChoiceItem().setTitle('1. Qual é o tema principal da Aula 24?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Participação e Condução de Reuniões Como liderar, intervir com firmeza e registrar decisões com eficiência', true),
      form.addMultipleChoiceItem().createChoice('Fundamentos de comunicação digital', false),
      form.addMultipleChoiceItem().createChoice('Estratégias de marketing avançado', false),
      form.addMultipleChoiceItem().createChoice('Análise de redes sociais', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('2. De acordo com a aula, qual é a relevância de: "Participação e Condução de Reuniões Como liderar, ..."?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('É um conceito importante apresentado na aula', true),
      form.addMultipleChoiceItem().createChoice('Não tem relevância prática', false),
      form.addMultipleChoiceItem().createChoice('Apenas para contexto acadêmico', false),
  ...
  form.addMultipleChoiceItem().setTitle('7. Como você aplicaria "Participação e Condução de Reuniões Como" em sua rotina profissional?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Na comunicação diária com colegas e superiores', true),
      form.addMultipleChoiceItem().createChoice('Apenas em situações formais extremas', false),
      form.addMultipleChoiceItem().createChoice('Nunca seria aplicável no trabalho', false),
  ...
  form.addMultipleChoiceItem().setTitle('16. Qual é a definição correta de "Feche com pergunta Convide a equipe à deliberação"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('“O que vocês acham de testarmos este caminho por uma semana?”.', true),
      form.addMultipleChoiceItem().createChoice('Conceito oposto a "Feche com pergunta Convide a equipe à deliberação"', false),
      form.addMultipleChoiceItem().createChoice('Uma ferramenta de trabalho genérica', false),
      form.addMultipleChoiceItem().createChoice('Um tipo de erro comum', false)
    ]).setRequired(true);

  form.addMultipleChoiceItem().setTitle('17. Qual é o objetivo principal ao estudar "Participação e Condução de Reuniões Como liderar, intervir com firmeza e registrar decisões com eficiência"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Aprimorar habilidades de comunicação profissional', true),
      form.addMultipleChoiceItem().createChoice('Memorizar datas e eventos históricos', false),
      form.addMultipleChoiceItem().createChoice('Aprender fórmulas matemáticas', false),
  ...
  form.addMultipleChoiceItem().setTitle('20. Resumindo, qual é a mensagem-chave que você retira de "Participação e Condução de Reuniões Como liderar, intervir com firmeza e registrar decisões com eficiência"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Compreender e aplicar os conceitos na prática profissional', true),
      form.addMultipleChoiceItem().createChoice('Apenas passar na avaliação', false),
      form.addMultipleChoiceItem().createChoice('Memorizar informações para futuro uso', false),
...
function criarFormularioAula25() {
  ...
  form.addMultipleChoiceItem().setTitle('16. Qual é a definição correta de "Fase 1"?')
    .setChoices([
      form.addMultipleChoiceItem().createChoice('Tensão Alta Tom de voz baixo e pausas intencionais de silêncio.', true),
